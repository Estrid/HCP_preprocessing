...
# 	rm ${glyphsets}/${subName}/${HEMI}.set
# 	for SURF in pial inflated very_inflated midthickness; do
# 		cmd="$workbench -gifti-convert \
# 		ASCII \
# 		${datadir}/${subName}/MNINonLinear/fsaverage_LR32k/${subName}.${HEMI}.${SURF}_MSMAll.32k_fs_LR.surf.gii \
# 		${glyphsets}/${subName}/${HEMI}.${SURF}.asc"
# 		echo $cmd
# 		$cmd
# 		echo ${HEMI}.${SURF}.asc >> ${glyphsets}/${subName}/${HEMI}.set
# 	done
...
for REST in REST1 REST2; do
	...
	COLUMN \
	-metric CORTEX_LEFT \
	${glyphsets}/${subName}/rfMRI_${REST}_${PHASEDIR}_Atlas_MSMAll_hp2000_clean.dtseries.left_metric.gii"
	echo $cmd
	$cmd
	...
	COLUMN \
	-metric CORTEX_RIGHT \
	${glyphsets}/${subName}/rfMRI_${REST}_${PHASEDIR}_Atlas_MSMAll_hp2000_clean.dtseries.right_metric.gii"
	echo $cmd
	$cmd
		...
		-${HEMI}-metric ${glyphsets}/${subName}/rfMRI_${REST}_${PHASEDIR}_Atlas_MSMAll_hp2000_clean.dtseries.${HEMI}_metric.gii"
		echo $cmd
		$cmd
		...
		-${HEMI}-surface ${datadir}/${subName}/MNINonLinear/fsaverage_LR32k/${subName}.L.very_inflated_MSMAll.32k_fs_LR.surf.gii"
		echo $cmd
		$cmd
...
for REST in REST1 REST2; do
	for PHASEDIR in RL LR; do
		...
		rm ${glyphsets}/${subName}/rfMRI_${REST}_${PHASEDIR}_Atlas_MSMAll_hp2000_clean.dtseries.${HEMI}_metric.gii
